...
export const translations = {
  el: {
    ...
    bar: {
      ...
      guestsCount: "{n} επισκέπτες",
      guestCount: "{n} επισκέπτης",
      book: "Κράτηση",
      adults13: "Ενήλικες",
      adults13Sub: "13+ ετών",
      children212: "Παιδιά",
      children212Sub: "2–12 ετών",
      infants2: "Βρέφη",
      infants2Sub: "Κάτω των 2",
      infantsFree: "Δωρεάν",
      maxGuestsHint: "Μέγιστη χωρητικότητα 7 άτομα (χωρίς τα βρέφη).",
      unavailable: "Μη διαθέσιμες",
      done: "Ολοκλήρωση",
    },
    bookingPage: {
      title: "Ολοκληρώστε το αίτημα κράτησης",
      subtitle: "Ελέγξτε τη σύνοψη και συμπληρώστε τα στοιχεία σας. Θα επικοινωνήσουμε σύντομα για επιβεβαίωση διαθεσιμότητας και τιμής.",
      ...
      children: "Παιδιά",
      infants: "Βρέφη",
      villa: "Ekaterini VIP Villa",
      villaLocation: "Πλάκα Αποκορώνου, Χανιά",
      ...
      successBody: "Το αίτημα κράτησής σας καταχωρήθηκε με επιτυχία. Θα επικοινωνήσουμε σύντομα μαζί σας για επιβεβαίωση της διαθεσιμότητας και της τιμής.",
      errOverlap: "Οι ημερομηνίες που επιλέξατε δεν είναι πλέον διαθέσιμες.",
      errRequired: "Παρακαλώ συμπληρώστε όλα τα υποχρεωτικά πεδία.",
      errEmail: "Παρακαλώ εισάγετε έγκυρο email.",
      errGeneric: "Παρουσιάστηκε σφάλμα. Δοκιμάστε ξανά.",
      microcopy: "Δεν χρεώνεστε τώρα. Θα σας στείλουμε επιβεβαίωση με email.",
    },
    faq: {
      eyebrow: "FAQ",
  ...
  en: {
    ...
    booking: {
      ...
      subtitle:
        "Fill in your preferred dates and we'll contact you to confirm availability and pricing.",
      cardTitle: "Choose your stay",
      name: "Full Name",
      email: "Email",
      phone: "Phone",
      ...
      submitting: "Sending...",
      microcopy: "We'll get back to you shortly to confirm availability and pricing.",
      or: "or contact us directly",
      pickDates: "Pick your dates",
      selectedRange: "Selected stay",
      nights: "nights",
      unavailableLegend: "Unavailable",
      success: "Your request has been submitted. We'll be in touch shortly.",
      errOverlap: "The selected dates are no longer available. Please pick different dates.",
      errDates: "Please pick a check-in and check-out date.",
      errMaxGuests: "The villa hosts up to 7 guests.",
    ...
    bar: {
      ...
      adults13: "Adults",
      adults13Sub: "Ages 13+",
      children212: "Children",
      children212Sub: "Ages 2–12",
      infants2: "Infants",
      infants2Sub: "Under 2",
      infantsFree: "Free",
      maxGuestsHint: "Max capacity 7 guests (infants not counted).",
      unavailable: "Unavailable",
      done: "Done",
    },
    bookingPage: {
      title: "Complete your booking request",
      subtitle: "Review the summary and fill in your details. We'll contact you shortly to confirm availability and pricing.",
      ...
      infants: "Infants",
      villa: "Ekaterini VIP Villa",
      villaLocation: "Plaka Apokoronou, Chania",
      ...
      successBody: "Your booking request has been submitted successfully. We'll get in touch shortly to confirm availability and pricing.",
      errOverlap: "The selected dates are no longer available.",
      errRequired: "Please fill in all required fields.",
      errEmail: "Please enter a valid email.",
      errGeneric: "Something went wrong. Please try again.",
      microcopy: "You won't be charged now. We'll send a confirmation by email.",
    },
    faq: {
      eyebrow: "FAQ",
