...
export const translations = {
  el: {
    ...
    booking: {
      ...
      subtitle:
        "Συμπληρώστε τα στοιχεία σας και θα επικοινωνήσουμε μαζί σας για επιβεβαίωση διαθεσιμότητας και τιμής.",
      name: "Ονοματεπώνυμο",
      email: "Email",
      phone: "Τηλέφωνο",
      ...
      success: "Το αίτημά σας στάλθηκε. Θα επικοινωνήσουμε σύντομα μαζί σας.",
    },
    faq: {
      eyebrow: "FAQ",
