...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:description", content: "Ekaterini VIP Villa στην Πλάκα Αποκορώνου, Χανιά. Ιδιωτική πισίνα, 3 υπνοδωμάτια έως 7 άτομα, BBQ, κήπος και δωρεάν πάρκινγκ." },
      { property: "og:site_name", content: "Ekaterini VIP Villa" },
      { name: "description", content: "Ekaterini VIP Villa στην Πλάκα Αποκορώνου, Χανιά. Ιδιωτική πισίνα, 3 υπνοδωμάτια έως 7 άτομα, BBQ, κήπος και δωρεάν πάρκινγκ." },
      { property: "og:description", content: "Ekaterini VIP Villa στην Πλάκα Αποκορώνου, Χανιά. Ιδιωτική πισίνα, 3 υπνοδωμάτια έως 7 άτομα, BBQ, κήπος και δωρεάν πάρκινγκ." },
