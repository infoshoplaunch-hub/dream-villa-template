...
export const Route = createFileRoute("/_authenticated/admin/gallery")({
  head: () => ({
    meta: [
      { title: "Διαχείριση Gallery — Ekaterini VIP Villa" },
      ...
      <main className="container-villa py-10">
        <div className="mx-auto max-w-6xl">
          ...
          <p className="mt-2 text-sm text-foreground/70">
            Ανέβασε ή διέγραψε φωτογραφίες που εμφανίζονται στη δημόσια σελίδα /gallery.
          </p>
                ...
                {photos.map((p) => (
                  <PhotoCard
                    ...
                    onSaveCaption={(caption) =>
                      captionMut.mutate({ id: p.id, caption })
                    }
                  />
                ))}
              </div>
