...
const SITE_NAME = "dream-villa-template"
  ...
  server: {
    handlers: {
      POST: async ({ request }) => {
        ...
        // Only admins may trigger arbitrary transactional emails. Without this
        // check, any self-registered user could send templated emails to
        // arbitrary recipients from the site's verified sending domain.
