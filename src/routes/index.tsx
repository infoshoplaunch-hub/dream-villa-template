...
function BookingBar() {
  ...
  return (
    <div id="booking-bar" className="mx-auto w-[calc(100%-32px)] max-w-[420px] md:w-full md:max-w-5xl rounded-3xl border border-white/40 bg-[hsl(35_40%_98%)]/98 shadow-[0_30px_70px_-25px_rgba(15,23,42,0.55)] backdrop-blur-xl pt-5">
  ...
  return (
    <section id="contact" className="section-y bg-[oklch(0.97_0.012_80)]">
      <div className="container-villa">
        ...
        {/* Άμεση Επικοινωνία — instant messaging card */}
        <div className="mx-auto mt-6 max-w-4xl rounded-2xl border border-border/60 bg-background p-6 shadow-[0_10px_30px_-20px_rgba(15,23,42,0.25)] md:p-8">
          ...
          <div className="mt-5 grid gap-5 sm:grid-cols-2">
            ...
            {/* Viber */}
            <div className="flex flex-col gap-4 rounded-xl border border-border/50 bg-[oklch(0.98_0.01_290)] p-5 sm:flex-row sm:items-center">
              <div
                className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full text-white"
